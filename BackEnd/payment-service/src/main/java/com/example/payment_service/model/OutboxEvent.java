...
public class OutboxEvent {
    ...
    private String aggregateType; // Ex: "Payment", "CryptoTransaction"

    @Column(name = "aggregate_id", nullable = false, length = 100)
    private String aggregateId; // ID de l'entité métier (Payment.id, etc.)

    @Column(name = "event_type", nullable = false, length = 100)
    private String eventType; // Ex: "PAYMENT_CREATED", "PAYMENT_VALIDATED", "PAYMENT_REJECTED"
