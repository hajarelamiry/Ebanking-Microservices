...
public interface AccountClient {
     ...
     * 
     * @param accountRef La référence du compte
     * @param payload Contient le montant à créditer
     * @return Les informations du compte mis à jour
     */
    @PostMapping("/api/accounts/{accountRef}/credit")
    @CircuitBreaker(name = "accountService", fallbackMethod = "fallbackCredit")
    Map<String, Object> credit(@PathVariable("accountRef") String accountRef, 
                               @RequestBody Map<String, BigDecimal> payload);
    ...
    default Map<String, Object> fallbackCredit(String accountRef, Map<String, BigDecimal> payload, Exception e) {
        throw new RuntimeException("Account Service unavailable. Cannot credit account: " + accountRef, e);
    }
